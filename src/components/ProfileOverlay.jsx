...
const ProfileOverlay = ({ isOpen, onClose }) => {
  const { selectedCategories, toggleCategory } = useTourContext();
      ...
      <div className="flex-1 overflow-y-auto space-y-10 pr-1 py-4">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="p-6 rounded-[28px] bg-sky-500/10 border-2 border-sky-500/50 flex items-center gap-5 cursor-pointer transition-all active:scale-[0.98]">
            ...
            <div className="p-6 rounded-[28px] bg-white/5 border border-white/10 flex items-center gap-5 cursor-pointer opacity-40 grayscale grayscale-100 transition-all hover:opacity-60 active:scale-[0.98]">
